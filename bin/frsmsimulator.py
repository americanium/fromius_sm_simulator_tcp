...
mqttuser = mqttcred['Brokeruser']
mqttpass = mqttcred['Brokerpass']
mqttaddressArray = mqttcred['Brokerhost'].split(":")
mqttPort = int(mqttcred['Brokerport'])
...
###############################################################
# Reading custom parameteres out of parameter file
###############################################################
